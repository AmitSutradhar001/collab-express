  ...
  return (
    <>
      <div className="w-full">
        <button onClick={handlePopup} className="flex justify-center items-center border-[1px] rounded-md p-3 text-center w-52 mt-5 ml-20 border-blue-700 font-semibold hover:bg-blue-500 hover:text-white hover:cursor-pointer text-blue-700">
          {popup ? "Cancle" : "Schedule War"}
        </button>
      </div>
      {/* {popup  } */}
      {popup? <><div>Amit</div></>:!err && data?.length > 0 && !popup ? (
        <>
          ...
          <section className="bg-white dark:bg-gray-900">
            <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
              <div className="mx-auto max-w-screen-sm text-center">
                ...
                <p className="mb-4 text-3xl tracking-tight font-bold text-blue-900 md:text-4xl dark:text-white">
                  Something's missing.
                </p>
                <p className="mb-4 text-lg font-light text-gray-500 dark:text-gray-400">
                  Sorry, we can't find the data.{" "}
                </p>
                <a
                  href="#"
